...
#define MQTT_IP_DEFAULT 192,168,43,247
#define MQTT_PROT_DEFAULT 1883
#define MQTT_USER_DEFAULT "z"
#define MQTT_PASSWORD_DEFAULT "2633063"
...
extern uint8 mqtt_ip[4];	//mqtt service ip
...
void user_setting_set_mqtt_ip(uint8 a,uint8 b,uint8 c,uint8 d);
